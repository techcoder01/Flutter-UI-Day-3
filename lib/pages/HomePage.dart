  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
       ...
       actions: [
        IconButton(onPressed: (){}, icon: Icon(Icons.shopping_cart, color: Colors.grey[800],)),
       ],
      ),
      body: SafeArea(
       child: Column(
        ...
        children: [
              ...
              Container(
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    FadeAnimation(1.4, makeCategory(isActive: false , title: "Kabab")),
                    FadeAnimation(1.5, makeCategory(isActive: false , title: "Salad")),
                    FadeAnimation(1.6, makeCategory(isActive: false , title: "Desserts")),
                  ],
                ),
              ),
              SizedBox(height: 10,),
          ...
          Expanded(child: Padding(padding: EdgeInsets.symmetric(horizontal: 20),child: ListView(
            scrollDirection: Axis.horizontal,
            children: [
  ...
  child: GestureDetector(
    child: Container(
      ...
      child: Container(
        ...
        child: const Padding(padding: const EdgeInsets.all(20), child: 
        Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                SizedBox(height: 10,),
                 Text('Chicken Pizza', style: TextStyle(color: Colors.white , fontSize: 20),),
              ],
            )
          ],
        ),),
